...
**Completed task:** Task 06C — Fair shared image admission across devices — committed as `176edaf`; verified: `mise exec python -- python -m pytest -q -W error tests/components/larapaper_bridge/test_image.py` — 101 passed; full integration suite — 215 passed; touched-file Ruff — all checks passed.
