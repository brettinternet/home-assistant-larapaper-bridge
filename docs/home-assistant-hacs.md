...
**Completed task:** Task 06C — Fair shared image admission across devices — committed as `176edaf`, `8de5f3f`; verified: `mise exec python -- python -m pytest -q -W error tests/components/larapaper_bridge/test_image.py` — 102 passed; full integration suite — 216 passed; touched-file Ruff — all checks passed.
