...
**Completed task:** Task 06D — Coalesced manual display cycle and native button — committed as `edf94e4`; verified: `mise exec python -- python -m pytest -q -W error tests/components/larapaper_bridge` — 224 passed; touched-file Ruff — all checks passed; production Pyright — OK.
