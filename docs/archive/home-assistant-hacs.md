...
**Status:** complete; remaining: none; archived: `docs/archive/home-assistant-hacs.md`; prior ARCHIVE blocker cleared by the established repository archive convention.
...
**Next action:** None; HA-HACS-06 and the scoped backlog are complete and archived at `docs/archive/home-assistant-hacs.md`.
